    ...
    <section className="py-24 px-6">
      <div className="relative z-10 flex flex-col items-center">
        ...
        <motion.div
          ...
          viewport={{ once: false, amount: 0.3 }}
        >
          <button className="px-9 py-3 rounded-full bg-[#8E24AA] text-white text-sm font-semibold shadow-sm">
            Monthly
          </button>
          <button className="px-9 py-3 rounded-full text-white text-sm font-medium hover:bg-white/10 transition">
            Annually
          </button>
        </motion.div>
